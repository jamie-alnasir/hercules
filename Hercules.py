...
_LFS_GTF_FILE_FILTERED_  = "/home/local/mxba001/hadoop-temp/flybase2006-exons.gtf";
#_LFS_GTF_FILE_FILTERED_  = "/home/local/mxba001/hadoop-temp/mus-mus-wholebrain-r1.gtf";

# CALIBRATION JOB FILES
#_LFS_GTF_FILE_FILTERED_  = "/home/local/mxba001/hadoop-temp/calibration.gtf";


# SAM reads file path
# NB: Changed to be an input parameter, no longer needs to be specified herein...
#_HDFS_SAM_READS_ = "hdfs://bigdata/user/mxba001/Drosophila/sam/sam_reads.sam";
